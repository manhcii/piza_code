...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        @php $lang = Request::get('lang')??"";@endphp
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        name="json_params[seo_title][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]"
                                                        class="form-control"
                                                        value="{{ old('json_params[seo_title][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        name="json_params[seo_keyword][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]"
                                                        class="form-control"
                                                        value="{{ old('json_params[seo_keyword][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        name="json_params[seo_description][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]"
                                                        class="form-control"
                                                        value="{{ old('json_params[seo_description][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}">
                                                </div>
                                            </div>
                                                                ...
                                                                <select class="form-control select2"
                                                                    ...
                                                                    @foreach ($parents as $item)
                                                                        @if ($item->parent_id == 0 || $item->parent_id == null)
                                                                            <option value="{{ $item->taxonomy }}">
                                                                                {{ $item->name }}</option>

                                                                            @foreach ($parents as $sub)
                                                                                @if ($item->id == $sub->parent_id)
                                                                                    <option value="{{ $sub->taxonomy }}">
                                                                                        - -
                                                                                        {{ $sub->name }}
                                                                                    </option>
                                                        ...
                                                        <li>
                                                            <label for="page-{{ $item->id }}">
                                                                ...
                                                                <input id="page-{{ $item->id }}"
                                                                    name="json_params[paramater][{{ $val_name }}][]"
                                                                    type="checkbox"
                                                                    {{ isset($detail->json_params->$val_name) && in_array($item->id, $detail->json_params->$val_name) ? 'checked' : '' }}
                                                                    value="{{ $item->propety_value }}">
