        ...
        <form role="form" action="{{ route(Request::segment(2) . '.store') }}" method="POST" id="form_product">
            ...
            <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="price_old"
                                                        placeholder="@lang('Price old')" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                ...
                <div class="col-lg-4">
                    ...
                    {{-- <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('Brands')</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <select name="json_params[brand]" class=" form-control select2">
                                    <option value="">@lang('Please select')</option>
                                    @foreach ($brands as $val)
                                        <option value="{{ $val->id }}"
                                            {{ isset($detail->json_params->brand) && $detail->json_params->brand == $val->id ? 'selected' : '' }}>
                                            @lang($val->title)</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                            ...
                                            <li>
                                                <label for="page-{{ $item->id }}">
                                                    <input id="page-{{ $item->id }}"  name="relation[]"
                                                        {{ $loop->index == 0 ? 'checked' : '' }} type="checkbox"
                                                        value="{{ $item->id }}">
                                                    {{ $item->name }}
                                                </label>
                                                <ul class="list-relation">
