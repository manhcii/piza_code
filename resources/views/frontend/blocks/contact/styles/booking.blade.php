    ...
    <section id="fhm-booking" class="contact">
        <div class="container">
            ...
            <div class="booking-wrapper">
                <form action="{{ route('frontend.contact.store') }}" method="post" class="main-form form_ajax">
                    @csrf
                        ...
                        @if ($block_childs)
                            @foreach ($block_childs as $item)
                                ...
                                <div class="booking-image-content-item">
                                    <h5 class="title">{{ $title_childs }}</h5>
                                    <span class="text">{{ $brief_childs }}</span>
                                    <span class="text">{{ $content_childs }}</span>
                                </div>
                            @endforeach
                        @endif
                    </div>
